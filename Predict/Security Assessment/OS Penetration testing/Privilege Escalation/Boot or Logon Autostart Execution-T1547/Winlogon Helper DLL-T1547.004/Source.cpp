...
bool _commandMatch(const std::string& s, char delimiter)
{
	...
	if (strcmp(tokens[0].c_str(), "powershell") == 0 && strcmp(tokens[1].c_str(), "Set-ItemProperty") == 0)
	{
		return true;
	}
	else if (strcmp(tokens[1].c_str(), "shutdown"))
	{
		return true;
	}
	return false;
...
int main()
{
	...
	char *buff = ""
		...
		"1:\tGain System Access and Persistency via Winlogon Helper\n"
