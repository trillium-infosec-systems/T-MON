...
bool _commandMatch(const std::string& s, char delimiter)
{
	...
	if (strcmp(tokens[0].c_str(), "bitsadmin") == 0 || strcmp(tokens[1].c_str(), "shell32.dll,Control_RunDLL") == 0)
	{
		return true;
	}
	else
...
int main()
{
	...
	char *buff = ""
		...
		"2:\tGain System Access using rundll32.exe to Run Control Panel Item\n";
