...
bool _commandMatch(const std::string& s, char delimiter)
{
	...
	else  if (tokens[0].find("msxsl.exe") != std::string::npos && tokens[1].find(".xml") != std::string::npos && tokens[2].find(".xsl") != std::string::npos)
	{
		return true;
	}
	else
...
int main()
{
	...
	char *buff = ""
		...
		"1:\tGain System Access using MSXSL\n"
