...
bool _commandMatch(const std::string& s, char delimiter)
{
	...
	if (strcmp(tokens[0].c_str(), "bitsadmin") == 0 || strcmp(tokens[0].c_str(), "ipconfig\n") == 0 || strcmp(tokens[0].c_str(), "reg") == 0 ||
		strcmp(tokens[0].c_str(), "Reg") == 0 || strcmp(tokens[0].c_str(), "REG") == 0)
	{
		return true;
	}
	return false;
...
int main()
{
	...
	char *buff = ""
		...
		"1:\tGain System Persistency Using \"ScreenSaver\"\n"
