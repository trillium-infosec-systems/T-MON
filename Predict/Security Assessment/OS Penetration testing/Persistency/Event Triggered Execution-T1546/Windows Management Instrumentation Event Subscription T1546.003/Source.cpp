...
bool _commandMatch(const std::string& s, char delimiter)
{
	...
	if (strcmp(tokens[0].c_str(), "powershell") == 0 || strcmp(tokens[0].c_str(), "ipconfig\n") == 0)
	{
		return true;
	}
	return false;
...
int main()
{
	...
	char *buff = ""
		...
		"1:\tGain System Access Using Powershell\n"
		"2:\tGain System Level Persistency using WMI\n\n";
