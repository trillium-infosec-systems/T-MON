...
int __cdecl main(void)
{
	...
	char *buff = ""
		...
		"You can only run Lnk File, Task is to GET Reverse SHELL\n\n";
	...
	do {
		...
		if (iResult > 0) {
			...
			if (command.find("Ipconfig") != std::string::npos || command.find("ipconfig") != std::string::npos ||
				command.find(".lnk") != std::string::npos || command.find("bitsadmin") != std::string::npos)
			{
