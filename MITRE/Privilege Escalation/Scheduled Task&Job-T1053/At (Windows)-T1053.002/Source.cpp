...
bool _commandMatch(const std::string& s, char delimiter)
{
	...
	if (strcmp(tokens[0].c_str(), "schtasks") == 0 || strcmp(tokens[0].c_str(), "shutdown") == 0)
	{
		std::cout << "found";
		return true;
	}
...
int main()
{
	...
	char *buff = ""
		...
		"1:\tGain System Access using Persistent Technique\n"
		"2:\tTask Scheduler is Your Best Friend\n\n";
