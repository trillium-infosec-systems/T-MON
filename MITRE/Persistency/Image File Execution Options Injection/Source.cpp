...
bool _commandMatch(const std::string& s, char delimiter)
{
	...
	if (strcmp(tokens[0].c_str(), "bitsadmin") == 0 || strcmp(tokens[0].c_str(), "reg") == 0 || strcmp(tokens[0].c_str(), "REG") == 0 || strcmp(tokens[0].c_str(), "Reg") == 0)
	{
		std::cout << "found";
		return true;
	}
...
int main()
{
	...
	char *buff = ""
		...
		"1:\tGain System Access using Image File Exection Option\n"
		"2:\tBitsadmin can be used to Download Meterpreter Payload\n\n";
